      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="flex items-center gap-4 bg-slate-900/40 border-l-4 border-primary">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mt-1">LKR {totalLiability.toLocaleString()}</h3>
          </div>
        </Card>
        ...
        <Card className="flex items-center gap-4 bg-slate-900/40 border-l-4 border-emerald-400">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mt-1">{staff.length} Members</h3>
          </div>
        </Card>
