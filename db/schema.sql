...
-- Profiles reference "user" table for auth
...
CREATE TABLE IF NOT EXISTS "subject_tutor" (
  ...
  tutorid INTEGER REFERENCES "tutor"(user_id) ON UPDATE CASCADE ON DELETE CASCADE NOT NULL,
...
CREATE TABLE IF NOT EXISTS "student_subject" (
  id SERIAL PRIMARY KEY,
  studentid INTEGER NOT NULL REFERENCES "student"(user_id) ON UPDATE CASCADE ON DELETE CASCADE,
  subjecttutorid INTEGER NOT NULL REFERENCES subject_tutor(id) ON UPDATE CASCADE ON DELETE CASCADE,
  is_active BOOLEAN NOT NULL DEFAULT TRUE,
  created_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS "chatroom" (
  id SERIAL PRIMARY KEY,
  user_id INT NOT NULL REFERENCES "student"(user_id) ON UPDATE CASCADE ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS "student_fees" (
  id SERIAL PRIMARY KEY,
  studentid INT NOT NULL REFERENCES "student"(user_id),
...
CREATE TABLE IF NOT EXISTS "tutor_payments" (
  id SERIAL PRIMARY KEY,
  tutorid INT NOT NULL REFERENCES "tutor"(user_id),
  month INT NOT NULL,
  year INT NOT NULL,
...
CREATE TABLE IF NOT EXISTS "flashcard" (
  id SERIAL PRIMARY KEY,
  studentid INTEGER NOT NULL REFERENCES "student"(user_id) ON DELETE CASCADE,
