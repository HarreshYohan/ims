...
export const StudentGoals = () => {
  ...
  const [form, setForm] = useState({ goaltitle: '', targetdate: '', subjecttutorid: '' });
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      setShowCreate(false);
      setForm({ goaltitle: '', targetdate: '', subjecttutorid: '' });
      toast.success('New goal set! You got this!');
